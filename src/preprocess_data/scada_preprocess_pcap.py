...
def split_large_pcap_file(dataset_name: str = None, pcap_file_name: str = None, mode: str = None, packets_per_file: int = 1000000):
    ...
    Args:
        dataset_name: Name of the dataset (e.g., "scada")
...
def filter_pcap_files(dataset_name: str = None, pcap_file_name: str = None, mode: str = None, protocol: str = None):
    ...
    Args:
        ...
        pcap_file_name: Name of the PCAP file without extension
        mode: Mode (e.g., "train", "test")
        protocol: ICS protocol to filter (e.g., "modbus")
    """
...
def process_scada_dataset(dataset_name: str = None, pcap_file_name: str = None, mode: str = None, protocol: str = None, packets_per_file: int = 1000000):
    """
    Complete SCADA dataset preprocessing pipeline: split large PCAP files and filter them.
    ...
    """
    print(f"Starting SCADA dataset preprocessing for {pcap_file_name}")
    ...
    print(f"\n=== SCADA dataset preprocessing completed successfully ===")
    return True


if __name__ == "__main__":
    # Example usage
    process_scada_dataset(
        dataset_name="scada",
        pcap_file_name="run1_12rtu(1)",  # run1_3rtu_2s, run1_6rtu(1), run1_12rtu(1)
        mode="train",
