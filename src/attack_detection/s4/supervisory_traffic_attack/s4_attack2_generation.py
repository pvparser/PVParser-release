...
from attack_detection.s4.supervisory_historian_attack.attack_injection_logging import (
    CSV_FILENAME,
    JSON_FILENAME,
    ...
    *,
    ...
    if attack_csv_paths:
        ...
        base_dir = (
            ...
            else repo_root / Path("src/attack_detection/s4/supervisory_historian_attack/data")
        )
...
def _default_attack2_supervisory_view_csv_dir(attack_label: str) -> Path:
    return (
        Path(_default_attack2_output_dir())
...
def _materialize_supervisory_view_attack_csv(
    ...
    effective_dir = _default_attack2_supervisory_view_csv_dir(source_attack_csv_path.stem)
...
def inject_attack_csv_into_pcap(
    ...
    *,
    ...
    pcap_output_path:
        ...
        ``s4/supervisory_traffic_attack/data/``.
    flow:
...
def main() -> None:
    ...
    for group in traffic_generation_groups:
        ...
        resolved_attack_csv_paths = _resolve_attack_csv_paths(
            ...
            attack_csv_dir=group.get("attack_csv_dir", "src/attack_detection/s4/supervisory_historian_attack/data"),
    ...
    summary_path = repo_root / Path(
        "src/attack_detection/s4/supervisory_traffic_attack/data/traffic_attack_summary.json"
    )
    summary = {
        "dataset_name": dataset_name,
