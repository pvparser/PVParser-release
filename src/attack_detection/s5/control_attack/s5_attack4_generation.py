...
from attack_detection.s5.supervisory_traffic_attack.s5_attack4_generation import (
    AttackPVSpec,
    FieldSpec,
    FlowMatchSpec,
    PacketFeatureSpec,
...
def _default_control_attack4_dir() -> Path:
    return SRC_ROOT / "attack_detection" / "s5" / "control_attack" / "data"
...
def _resolve_attack_csv_paths(
    ...
    if not csv_dir.exists():
        raise FileNotFoundError(
            ...
            "Run the s5 supervisory historian generator first or set attack_csv_dir manually."
        )
...
def main() -> None:
    ...
    # attack_csv_path = "src/attack_detection/s5/supervisory_historian_attack/data/_control_attack_csv/test_00.csv"
