...
from attack_detection.s3.supervisory_historian_attack.attack_injection_logging import (
    ...
    if _SCAPY_CACHE is None:
        try:
            ...
            raise ModuleNotFoundError(
                "scapy is required for s3 supervisory traffic generation. "
    ...
    *,
    ...
    if attack_csv_paths:
        ...
        base_dir = (
            ...
            else repo_root / Path("src/attack_detection/s3/supervisory_historian_attack/data")
        )
...
def inject_attack_csv_into_pcap(
    ...
    *,
    ...
    pcap_output_path:
        ...
        ``s3/supervisory_traffic_attack/data/``.
    flow:
...
def main() -> None:
    ...
    for group in traffic_generation_groups:
        ...
        resolved_attack_csv_paths = _resolve_attack_csv_paths(
            ...
            attack_csv_dir=group.get("attack_csv_dir", "src/attack_detection/s3/supervisory_historian_attack/data"),
    ...
    summary_path = repo_root / Path(
        "src/attack_detection/s3/supervisory_traffic_attack/data/traffic_attack_summary.json"
    )
    summary = {
        "dataset_name": dataset_name,
